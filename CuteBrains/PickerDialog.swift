...
//  CuteBrains
//
//  Created by methlouthi syrine on 3/6/19.
...
class PickerDialog: UIView, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func show(title: String, doneButtonTitle: String = "Done", cancelButtonTitle: String = "Cancel", options: [[String: String]], selected: String? = nil, callback: @escaping PickerCallback) {
        ...
        NotificationCenter.defaultCenter.addObserver(self, selector: "deviceOrientationDidChange:", name: UIDeviceOrientationDidChangeNotification, object: nil)
    ...
    private func close() {
        ...
        UIView.animate(
            withDuration: 0.2,
            delay: 0,
            options: UIView.AnimationOptions.TransitionNone,
            animations: { () -> Void in
                self.backgroundColor = UIColor(red: 0, green: 0, blue: 0, alpha: 0)
